module Sanitarios
  class ServicioQuirurgico
    ...
    public :to_s, :==, :num_quirofanos, :num_personal, :obtener_estados_individuales, :total_personal_turno, :<=>, :coste_total, :indicador_costo_por_quirofano, :indicador_costo_por_personal
