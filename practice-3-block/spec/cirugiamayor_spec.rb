...
RSpec.describe Sanitarios::CirugiaMayor do
  ...
  context "Pruebas de Validación (Heredadas de ServicioQuirurgico)" do
    ...
    it "debe lanzar ArgumentError si la lista de personal está vacía ([])" do
      expect { 
        Sanitarios::CirugiaMayor.new(id_valido, nombre_valido, quirofanos_validos, [], precio_valido) 
    ...
    it "debe lanzar ArgumentError si la lista de quirófanos está vacía ([])" do
      expect { 
        Sanitarios::CirugiaMayor.new(id_valido, nombre_valido, [], personal_valido, precio_valido) 
